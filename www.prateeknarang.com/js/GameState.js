...
console.log("IN Create !");
	...
	*/
	...
	moving_coin.animations.add('fly');
	moving_coin.animations.play('fly',10,true);
   ...
   //Add Explosion object pool
	...
	var style = { font: "16px Roboto", fill: "#fff", align: "center" };
	...
	game.add.text(5200,h-70,'*Percentiles as calculated by HackerEarth',{font:"20px Roboto",fill:"#fff"});
	...
	game.add.sprite(10000-100,h-330,'frog').scale.setTo(0.8,0.8);
	game.add.sprite(10200,h-360,'frog').scale.setTo(0.9,0.9);
	game.add.sprite(10500,h-385,'frog');
	game.add.sprite(10800,h-450,'frog').scale.setTo(1.2,1.2);
	game.add.sprite(11150,h-485,'frog').scale.setTo(1.3,1.3);
    game.add.sprite(11500,h-540,'frog').scale.setTo(1.5,1.5);

	//Add logos
    var shift = 100;
	game.add.sprite(10010-shift,h-210,'campk12Logo').scale.setTo(0.75,0.75);
	game.add.sprite(10310-shift,h-230,'instaLogo');
	game.add.sprite(10620-shift,h-235,'hackerearthLogo').scale.setTo(0.48,0.48);
	game.add.sprite(10970-shift,h-280,'sandiskLogo');
	game.add.sprite(11320-shift-50,h-300,'cbLogo').scale.setTo(0.6,0.6);
    game.add.sprite(11720-shift-50,h-330,'glogo').scale.setTo(0.1,0.1);

	//Add company texts.
	var style_ex = {font:"16px Roboto",fill:orange,align:"center"};
	var style_exS = {font:"12px Roboto",fill:orange,align:"center"};
	game.add.text(10080-shift,h-210,"Camp K-12, Delhi \n Sept-Oct 2013 \n Design Instructor",style_exS);
	game.add.text(10390-shift,h-220,"InstaLabs, Gurgaon \n June-July 2014 \n Android Developer",style_exS);
	game.add.text(10575,h-230,"HackerEarth\n March-April 2015 \n Problem Setter",style_ex); 
	game.add.text(10900,h-250,"Bangalore \n June-July 2015 \n Firmware Developer\n Intern",style_ex);
	game.add.text(11320-50,h-290,"Coding Blocks,Delhi \n Aug'2015-Oct'2020\nCourse Instructor &\n Co-founder",style_ex);

    game.add.text(11720-150,h-260,"November 2020-Present\nSoftware Engineer, Google Hyderabad",style_ex);
    
	var pd = game.add.sprite(10875-shift,h-220,'sandiskPd');
	pd.scale.setTo(1.2,1.2);
	pd.angle = -30;

	//Add projects
	game.add.sprite(12200,h-370,'games');
	game.add.text(12280,h-430,"Developed Android Game \n 5k+ Downloads  \n Rated 4.8/5.0 on Google Play",style_white);
	...
	game.add.tileSprite(base5+500,h-100-73*3,119*3,73*3+10,'squarebrick');
	...
	game.add.text(base5+2650,h-420,"Winning Team member\n Code For India \n Google Hackathon for",{font:"30px Roboto",fill:"#fff",align:"center"});
	...
	game.add.text(base7+650,h-550+20,"BLOG",{font:"40px Roboto" ,fill:"#fff"});
	...
	*/
	...
	inst_text = game.add.text(290,h-50,"Use  ARROW KEYS OR <<SCREEN BUTTONS>> to navigate",{font:"30px Roboto",fill:"#fff"});
	//Add hero 
...
function gameupdate(){
	...
	if(hero.x>platformLength-350){
		...
		t.start();
		t.onComplete.add(function(){game.add.text(platformLength-185,h-370,"THANK\n YOU!",style_white);},this);
